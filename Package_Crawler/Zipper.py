...
As of yet there is no exception handling or unit tests built into the project. For now package crawler is a simple
Python project that gets a monotonous task done quickly. If I've shared the GitHub repo with you feel free to contribute.
